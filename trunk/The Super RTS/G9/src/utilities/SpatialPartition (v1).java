 ...
 *
 */
public final class SpatialPartitionV1 extends Region
{
	...
	public static void main(String[] args)
	{
		...
		SpatialPartition sp = new SpatialPartition(0, 0, width, height, 40, 60, 100);
		for(int i = 0; i < regions.length; i++)
		{
			regions[i] = new Region(Math.random()*width, Math.random()*height, 20, 20);
			sp.addRegion(regions[i]);
		}
		System.out.println("regions in partition = "+sp.trueSize());
	}
	/**
