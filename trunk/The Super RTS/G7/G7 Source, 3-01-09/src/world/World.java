...
public class World implements Runnable
{
	...
	public static void main(String[] args)
	{
		...
		String map = new String(System.getProperty("user.dir")+System.getProperty("file.separator")+"fairSpawn2.wrld");
		ArrayList<String> ais = new ArrayList<String>();
		ais.add("WiFAI2v2.class"); //top left
		ais.add("WiFAI.class"); //bottom right
	...
	{
		String dir = System.getProperty("user.dir")+System.getProperty("file.separator")+"bin\\customAI"+System.getProperty("file.separator");
