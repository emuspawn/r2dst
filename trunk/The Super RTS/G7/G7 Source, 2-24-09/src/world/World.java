...
public class World implements Runnable
{
	...
	public World(String mapFileName, ArrayList<String> AIFileNames)
	{
		...
		{
			ait.add(new AIThread(ais.get(i)));
		}
	...
	public static void main(String[] args)
	{
		...
		String map = new String(System.getProperty("user.dir")+System.getProperty("file.separator")+"test2.wrld");
		ArrayList<String> ais = new ArrayList<String>();
		ais.add("TestAI.class"); //bottom left
		ais.add("TestAI.class"); //top right
