...
public class TileKyle
{
	...
	public TileKyle(int x, int y, int length)
	{
	...
	public double getFScore(Point dti, Unit u, boolean[][] checkedTiles)
	{
		if((type == 1 || type == 2) && type != u.getMovementType())
		{
			System.out.println("f score = 999999, wrong type");
			return 999999;
		}
		if(checkedTiles[bounds.x][bounds.y])
		{
			System.out.println("f score = 999999, already checked tile");
			return 999999;
		}
