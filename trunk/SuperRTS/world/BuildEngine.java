...
class BuildItem
{
	...
	public void upCounter(UnitEngine ue)
	{
		...
		{
			ue.getUnits().add(u);
			//u.getOwner().setUnitCount(be, u.getOwner().getUnitCount()+u.getPopulationValue());
			//u.getOwner().setCurrentUnitMax(be, u.getOwner().getCurrentUnitMax()+u.getPopulationAugment());
			constructed = true;
		}
	}
